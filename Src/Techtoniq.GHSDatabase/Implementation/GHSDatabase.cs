...
namespace Techtoniq.GHSDatabase
{
    public class GhsDatabase : IGhsDatabase
    {
        ...
        {
            { new KeyValuePair<string, IHazard>("H200", new Hazard(HazardClass.Explosives, new HazardCategory[]{ HazardCategory.UnstableExplosive}, new byte[][] { Properties.Resources.ghs01 }, SignalWord.Danger, new PCode[]{ new PCode("P201"), new PCode("P202"), new PCode("P281"), new PCode("P372"), new PCode("P373"), new PCode("P380"), new PCode("P401"), new PCode("P501")}) ) },
            { new KeyValuePair<string, IHazard>("H201", new Hazard(HazardClass.Explosives, new HazardCategory[]{ HazardCategory.Div1_1}, new byte[][] {Properties.Resources.ghs01 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P230"), new PCode("P240"), new PCode("P250"), new PCode("P280"), new PCode("P370+P380"), new PCode("P372"), new PCode("P373"), new PCode("P401"), new PCode("P501") }) )},
            { new KeyValuePair<string, IHazard>("H202", new Hazard(HazardClass.Explosives, new HazardCategory[]{ HazardCategory.Div1_2 }, new byte[][] {Properties.Resources.ghs01 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P230"), new PCode("P240"), new PCode("P250"), new PCode("P280"), new PCode("P370+P380"), new PCode("P372"), new PCode("P373"), new PCode("P401"), new PCode("P501") }) )},
            { new KeyValuePair<string, IHazard>("H203", new Hazard(HazardClass.Explosives, new HazardCategory[]{ HazardCategory.Div1_3}, new byte[][] {Properties.Resources.ghs01 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P230"), new PCode("P240"), new PCode("P250"), new PCode("P280"), new PCode("P370+P380"), new PCode("P372"), new PCode("P373"), new PCode("P401"), new PCode("P501") }) )},
            { new KeyValuePair<string, IHazard>("H204", new Hazard(HazardClass.Explosives, new HazardCategory[]{ HazardCategory.Div1_4}, new byte[][] {Properties.Resources.ghs01 }, SignalWord.Warning, new PCode[]{new PCode("P210"), new PCode("P240"), new PCode("P250"), new PCode("P280"), new PCode("P370+P380"), new PCode("P372"), new PCode("P373"), new PCode("P374"), new PCode("P401"), new PCode("P501") }) )},
            ...
            { new KeyValuePair<string, IHazard>("H220", new Hazard(HazardClass.FlammableGases, new HazardCategory[]{ HazardCategory.Category1}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P377"), new PCode("P381"), new PCode("P403") }) )},
            ...
            { new KeyValuePair<string, IHazard>("H222", new Hazard(HazardClass.FlammableAerosoles, new HazardCategory[]{ HazardCategory.Category1}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P211"), new PCode("P251"), new PCode("P410+P412") }) )},
            { new KeyValuePair<string, IHazard>("H223", new Hazard(HazardClass.FlammableAerosoles, new HazardCategory[]{ HazardCategory.Category2}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Warning, new PCode[]{new PCode("P210"), new PCode("P211"), new PCode("P251"), new PCode("P410+P412") }) )},

            { new KeyValuePair<string, IHazard>("H224", new Hazard(HazardClass.FlammableLiquids, new HazardCategory[]{ HazardCategory.Category1}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P233"), new PCode("P240"), new PCode("P241"), new PCode("P242"), new PCode("P243"), new PCode("P280"), new PCode("P303+P361+P353"), new PCode("P370+P378"), new PCode("P403+P235"), new PCode("P501") }) )},
            { new KeyValuePair<string, IHazard>("H225", new Hazard(HazardClass.FlammableLiquids, new HazardCategory[]{ HazardCategory.Category2}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P233"), new PCode("P240"), new PCode("P241"), new PCode("P242"), new PCode("P243"), new PCode("P280"), new PCode("P303+P361+P353"), new PCode("P370+P378"), new PCode("P403+P235"), new PCode("P501") }) )},
            { new KeyValuePair<string, IHazard>("H226", new Hazard(HazardClass.FlammableLiquids, new HazardCategory[]{ HazardCategory.Category3}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Warning, new PCode[]{new PCode("P210"), new PCode("P233"), new PCode("P240"), new PCode("P241"), new PCode("P242"), new PCode("P243"), new PCode("P280"), new PCode("P303+P361+P353"), new PCode("P370+P378"), new PCode("P403+P235"), new PCode("P501") }) )},

            { new KeyValuePair<string, IHazard>("H228", new Hazard(HazardClass.FlammableSolids, new HazardCategory[]{ HazardCategory.Category1}, new byte[][] {Properties.Resources.ghs02 }, SignalWord.Danger, new PCode[]{new PCode("P210"), new PCode("P240"), new PCode("P241"), new PCode("P280"), new PCode("P370+P378") }) )},
